...
//                 author: "Robert  T. Kiyosaki e Sharon l. Lechte",
//             },
...
//     console.log(`Livros do autor Augusto Cury: ${books} | Total de Livros: ${books.length}`)
// }
...
//     console.log(`Livros do autor ${author}: ${books.join(', ')} | Total de Livros: ${books.length}`)
// }
